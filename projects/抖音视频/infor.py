...
class Task:
    ...
    async def save_data(self, data):
        for aweme in data["aweme_list"]:
            ...
            titles = ""
            titles_list = ["作品id", "时间", "标题", "格式", "收藏", "评论", "点赞", "分享"]
    ...
    def time_count(self):
        ...
        printt(f"共采集{self.nickname}的{self.video}个视频和{self.picture}个图片,共耗时{time_diff}秒。")


async def main():
    url = "https://www.douyin.com/user/MS4wLjABAAAA1z5kwBvCPAEdlh6C5RtprWxGGMR2DajkYW_z9rBpZO4"
    cookie = "UIFID_TEMP=c4683e1a43ffa6bc6852097c712d14b81f04bc9b5ca6d30214b0e66b4e385280c23c7c48242b468a0c726cc174229b6b54066759308ba931c0bf2c372460f7abd1e0d13e7e34d63c75c63641f4010366; s_v_web_id=verify_lxkjpugn_jiF35RSY_NL5v_4jZk_BWJC_85iGJznjc4fd; passport_csrf_token=ab189923b0a230c3769979c05b45d435; passport_csrf_token_default=ab189923b0a230c3769979c05b45d435; fpk1=U2FsdGVkX18+k4vGpmE48bOsUwHcnRO07qEIWDgS8Ps4NgSK4T0Ja+4Zeh5IXjmo5Q7tjl2BKC4+36MnW0siHg==; fpk2=5f4591689f71924dbd1e95e47aec4ed7; bd_ticket_guard_client_web_domain=2; passport_assist_user=CkHkyn6-1sUx2Fkm5OtccBRDZhsMQI6ss9GS8t8qg4LewMs7ZrxVEXCWrvPBvvX1uIKQWr5k7UvqQnhWr2uoLlftLRpKCjwLrH-2dQaDt1f4L9ozmxfWPmSPb69mdZb9ooU0v5NOGjiK8f2u1rk3YNwE_UAUHqujN9EzWo5DsDBE5aQQ3K_UDRiJr9ZUIAEiAQMVKkUY; n_mh=kOWdes8h5KwAB7ZYvlwBX3e-HzkC3ZMjB1jH9Pr98mk; sso_uid_tt=5118dc8498c45d09f8cc502676bd06af; sso_uid_tt_ss=5118dc8498c45d09f8cc502676bd06af; toutiao_sso_user=1b3d854db42c504a4cf573bbb9b4d622; toutiao_sso_user_ss=1b3d854db42c504a4cf573bbb9b4d622; sid_ucp_sso_v1=1.0.0-KDM3OGMzOWY0Y2MwY2JkZDI0N2Y3MWZlMmFjZDdjMzViYzQ5OTU2NTMKIQiInMDkw8yABxDMycazBhjvMSAMMLmSj6IGOAZA9AdIBhoCbGYiIDFiM2Q4NTRkYjQyYzUwNGE0Y2Y1NzNiYmI5YjRkNjIy; ssid_ucp_sso_v1=1.0.0-KDM3OGMzOWY0Y2MwY2JkZDI0N2Y3MWZlMmFjZDdjMzViYzQ5OTU2NTMKIQiInMDkw8yABxDMycazBhjvMSAMMLmSj6IGOAZA9AdIBhoCbGYiIDFiM2Q4NTRkYjQyYzUwNGE0Y2Y1NzNiYmI5YjRkNjIy; passport_auth_status=c9e1c3f7c4c99a45129f2b1b8852c0d9%2C; passport_auth_status_ss=c9e1c3f7c4c99a45129f2b1b8852c0d9%2C; uid_tt=cece1755837351268adca7f928788120; uid_tt_ss=cece1755837351268adca7f928788120; sid_tt=ae5c52a849a842c6e93c0c6efb191776; sessionid=ae5c52a849a842c6e93c0c6efb191776; sessionid_ss=ae5c52a849a842c6e93c0c6efb191776; UIFID=; _bd_ticket_crypt_doamin=2; _bd_ticket_crypt_cookie=4ac4a9813bf6d6b2c87005b239dfb0b6; __security_server_data_status=1; sid_guard=ae5c52a849a842c6e93c0c6efb191776%7C1718723794%7C5183996%7CSat%2C+17-Aug-2024+15%3A16%3A30+GMT; sid_ucp_v1=1.0.0-KDQ3NmJhODgyNDk4MGJjZmU2MDczMGM2NzE5ODU5YjlkMjU1ZmU0NWUKGwiInMDkw8yABxDSycazBhjvMSAMOAZA9AdIBBoCaGwiIGFlNWM1MmE4NDlhODQyYzZlOTNjMGM2ZWZiMTkxNzc2; ssid_ucp_v1=1.0.0-KDQ3NmJhODgyNDk4MGJjZmU2MDczMGM2NzE5ODU5YjlkMjU1ZmU0NWUKGwiInMDkw8yABxDSycazBhjvMSAMOAZA9AdIBBoCaGwiIGFlNWM1MmE4NDlhODQyYzZlOTNjMGM2ZWZiMTkxNzc2; store-region=cn-hb; store-region-src=uid; SEARCH_RESULT_LIST_TYPE=%22single%22; my_rd=2; ttwid=1%7C61et_3dCOXH3jXOGBBwQeY-xS8JRS8zDDyaK9cH_GmM%7C1718956217%7C518c0e1215719781f20a1592aba7986fc78d60fd64bb44081e7560fe86db347d; live_use_vvc=%22false%22; download_guide=%223%2F20240618%2F1%22; EnhanceDownloadGuide=%220_0_0_0_1_1720241511%22; dy_swidth=1536; dy_sheight=864; volume_info=%7B%22isUserMute%22%3Afalse%2C%22isMute%22%3Afalse%2C%22volume%22%3A0.4%7D; pwa2=%220%7C0%7C3%7C1%22; publish_badge_show_info=%220%2C0%2C0%2C1720590087947%22; __live_version__=%221.1.2.1752%22; live_can_add_dy_2_desktop=%220%22; strategyABtestKey=%221720657096.853%22; douyin.com; device_web_cpu_core=16; device_web_memory_size=8; architecture=amd64; csrf_session_id=133bd5b12f5cd696a747efe44b1935aa; xg_device_score=7.724510600160288; passport_fe_beating_status=true; WallpaperGuide=%7B%22showTime%22%3A1720306856080%2C%22closeTime%22%3A0%2C%22showCount%22%3A6%2C%22cursor1%22%3A468%2C%22cursor2%22%3A0%2C%22hoverTime%22%3A1718869866779%7D; stream_recommend_feed_params=%22%7B%5C%22cookie_enabled%5C%22%3Atrue%2C%5C%22screen_width%5C%22%3A1536%2C%5C%22screen_height%5C%22%3A864%2C%5C%22browser_online%5C%22%3Atrue%2C%5C%22cpu_core_num%5C%22%3A16%2C%5C%22device_memory%5C%22%3A8%2C%5C%22downlink%5C%22%3A10%2C%5C%22effective_type%5C%22%3A%5C%224g%5C%22%2C%5C%22round_trip_time%5C%22%3A50%7D%22; odin_tt=cb1cac1711d549603e4a2c4a89ecd233a63d7d656776ea65cb2c2fdeb9c46927b630969fd45e743b786f00f76ac89bfa; __ac_nonce=0668fe8d300538cc5ea23; __ac_signature=_02B4Z6wo00f01LkJTYQAAIDAji2J2jXcmfi5KUkAAEjSd1; home_can_add_dy_2_desktop=%221%22; bd_ticket_guard_client_data=%3D%3D; stream_player_status_params=%22%7B%5C%22is_auto_play%5C%22%3A0%2C%5C%22is_full_screen%5C%22%3A0%2C%5C%22is_full_webscreen%5C%22%3A1%2C%5C%22is_mute%5C%22%3A0%2C%5C%22is_speed%5C%22%3A1%2C%5C%22is_visible%5C%22%3A1%7D%22; IsDouyinActive=true"
