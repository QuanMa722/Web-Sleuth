...
class Task(object):
    ...
    def task(self):
        form = 'device_platform=webapp&aid=6383&channel=channel_pc_web&sec_user_id=' + self.sec_user_id + '&max_cursor=' + str(
    ...
    if ex:
        ...
        for aa in urls:
            ...
            if "video" in a or "note" in a:
                ...
                a = findall(r'/user/([A-Za-z0-9_-]+)', a)[0]
